...
class ConvGRUCell(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, bias, dtype, activation=nn.Tanh):
        """
...
class ConvGRU(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
                 dtype, batch_first=False, bias=True, return_all_layers=False, activation=nn.Tanh):
        """
        :param input_size: (int, int)
            Height and width of input tensor as (height, width).
...
if __name__ == '__main__':
    ...
    activation_function = nn.ReLU  # Change activation function here
